...
<div class="col-right">
<img src="media/images/Yale_Logo.svg" style="max-width: 100%; height: auto; object-fit: contain;">
</div>
...
![width:400px](Meeting_260120/src/Presentation/media/Figure1.png)
...
![](Meeting_260120/src/Presentation/media/Figure2.png)
...
<div class="container">
   ...
   **Dynamic Decoupling (DD)** sequences, consisting of multi-pulse control on the NV spin, have been developed to achieve entangling gates with selected target nuclear spins while reducing decoherence from the broader spin bath. 
   ...
   ![width:400px](Meeting_260120/src/Presentation/media/DDrf_sequence.png)
