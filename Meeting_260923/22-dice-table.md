...
Consider two independent dice $X$ and $Y$, and ask for the probability of their sum, $Z=X+Y$. The natural picture is a table of $36$ cells, one per pair $(X,Y)$, each with weight $\tfrac{1}{36}$.
...
<video src="media/dice-grid.mp4" poster="media/dice-grid.png" width="720" controls autoplay loop muted playsinline preload="none"></video>
